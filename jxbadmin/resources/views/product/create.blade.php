...
@section('content')
    <div class="container mt-5">
        ...
        <form action="/products" method="POST" enctype="multipart/form-data" class="w-25">
            @csrf
            <div class="mb-3">
                <label for="exampleFormControlInput1" class="form-label">Title</label>
                <input type="text" class="form-control text-capitalize @error('title') is-invalid @enderror" id="exampleFormControlInput1" name="title" value="{{old('title')}}">
                @error('title')
